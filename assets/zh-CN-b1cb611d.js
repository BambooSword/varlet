...
`),s("span",{class:"hljs-tag"},[t("</"),s("span",{class:"hljs-name"},"template"),t(">")]),t(`
`)])],-1),T={class:"card"},C={id:"han2shu4shi4diao4yong4"},N=s("p",null,[t("函数式的调用是直接更新 "),s("code",null,":root"),t(" 上的变量，适合需要全局更新样式的情况。")],-1),P=s("pre",{class:"hljs"},[s("code",null,[s("span",{class:"hljs-tag"},[t("<"),s("span",{class:"hljs-name"},"script"),t(),s("span",{class:"hljs-attr"},"setup"),t(">")]),s("span",{class:"javascript"},[t(`
