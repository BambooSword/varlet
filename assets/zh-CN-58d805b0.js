...
`)])],-1),B=a("h2",null,"API",-1),C={class:"card"},W={id:"cha1jian4xuan3xiang4"},q=r("<table><thead><tr><th>参数</th><th>说明</th><th>类型</th><th>默认值</th></tr></thead><tbody><tr><td><code>loading</code></td><td>加载中的图片，尽可能选择加载速度很快的图片</td><td><em>string</em></td><td><code>1像素透明图片</code></td></tr><tr><td><code>error</code></td><td>加载失败显示的图片</td><td><em>string</em></td><td><code>1像素透明图片</code></td></tr><tr><td><code>attempt</code></td><td>加载失败时尝试重新加载的次数</td><td><em>number</em></td><td><code>3</code></td></tr><tr><td><code>throttleWait</code></td><td>节流时间，数值越大事件触发频率越低</td><td><em>number</em></td><td><code>300</code></td></tr><tr><td><code>events</code></td><td>触发可见性检测注册的事件列表</td><td><em>string[]</em></td><td><code>[&#39;scroll&#39;...]</code></td></tr><tr><td><code>filter</code></td><td>属性拦截函数</td><td><em>(lazy: Lazy) =&gt; void</em></td><td><code>() =&gt; void</code></td></tr></tbody></table>",1);function E(I,P,Q,S,T,Z){const l=c("router-link"),e=c("var-site-code-example");return o(),p("div",i,[j,a("div",g,[a("h3",m,[t(l,{to:"#jie4shao4"},{default:n(()=>[s("#")]),_:1}),s("介绍")]),u]),a("div",_,[a("h3",b,[t(l,{to:"#ji1ben3shi3yong4"},{default:n(()=>[s("#")]),_:1}),s("基本使用")]),t(e,null,{default:n(()=>[v]),_:1})]),a("div",y,[a("h3",x,[t(l,{to:"#bei4jing3tu2lan3jia1zai4"},{default:n(()=>[s("#")]),_:1}),s("背景图懒加载")]),t(e,null,{default:n(()=>[z]),_:1})]),a("div",f,[a("h3",k,[t(l,{to:"#nei4lian2shu3xing4"},{default:n(()=>[s("#")]),_:1}),s("内联属性")]),w,t(e,null,{default:n(()=>[N]),_:1})]),a("div",L,[a("h3",V,[t(l,{to:"#cha1jian4"},{default:n(()=>[s("#")]),_:1}),s("插件")]),$,t(e,{"playground-ignore":""},{default:n(()=>[A]),_:1})]),B,a("div",C,[a("h3",W,[t(l,{to:"#cha1jian4xuan3xiang4"},{default:n(()=>[s("#")]),_:1}),s("插件选项")]),q])])}const F=h(d,[["render",E]]);export{F as default};
